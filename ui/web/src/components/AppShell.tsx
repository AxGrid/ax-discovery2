...
import { Avatar, AvatarFallback, Button, ThemeToggle } from "@/components/ui";
import { Activity, FileText, Info, Layers, LogOut, Network, Users as UsersIcon } from "lucide-react";
...
export function AppShell() {
  ...
  return (
    <div className="h-screen flex bg-bg text-fg">
      ...
      {/* Mobile top bar */}
      <div className="md:hidden fixed top-0 inset-x-0 h-14 z-30 bg-bg-elevated border-b border-border px-3 flex items-center gap-2">
        <Logo size={26} />
